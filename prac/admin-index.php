                         ...
                         <div class="table-responsive">
                             ...
                             <table id="faqs" class="table table-hover">
                                 ...
                                 <tbody>
                                        ...
                                        <tr><td><input type="text" class="form-control" name="firstName" placeholder="First name"></td></tr>
                                         <tr><td><input type="text" class="form-control" name="lastName" placeholder="Last name"></td></tr>
                                         <tr><td><input type="text" placeholder="Address" name="address[]" class="form-control"></td>
